...
/* package CHESSAI-0.1.0.0 */
#ifndef VERSION_CHESSAI
#define VERSION_CHESSAI "0.1.0.0"
#endif /* VERSION_CHESSAI */
#ifndef MIN_VERSION_CHESSAI
#define MIN_VERSION_CHESSAI(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
...
#define CURRENT_COMPONENT_ID "CHESSAI-0.1.0.0-inplace-chess-tests"
